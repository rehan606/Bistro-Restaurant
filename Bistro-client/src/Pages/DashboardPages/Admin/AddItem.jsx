...
const AddItem = () => {
    ...
    return (
        <div>
            <section>
                <SectionTitle headding="What's New" subHeadding=" Add An Item"></SectionTitle>
            </section>
            ...
            <div className='w-6/12 mx-auto bg-gray-200 p-10 mt-10'>
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <button type="submit" className='w-full btn flex items-center text-center py-4 bg-blue-800 hover:bg-gray-900 text-white rounded-md mt-5'>Add Item <FaUtensils/>  </button>
